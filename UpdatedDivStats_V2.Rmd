...
### Updated diversity statistics for Julia

Hey Julia, thanks for being patient as it's taken me a while to get back to you. This is the most recent version of the D-val table, with some additional figures and analysis that Valerie asked for. Most steps should be annotated - hope this can be followed.
